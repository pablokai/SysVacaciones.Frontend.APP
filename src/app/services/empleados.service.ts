...
export class EmpleadosService {
  ...
  insertarEmpleados(Empleado : Empleados) : Observable<Empleados> {
    return this.http.post<Empleados>(this.apiUrl + 'Empleados/InsertarEmpleado', Empleado ).pipe(
      catchError(error =>[])
    );
  }

  editarEmpleados(Empleado : Empleados) : Observable<Empleados> {
    return this.http.post<Empleados>(this.apiUrl + 'Empleados/ModificarEmpleado', Empleado ).pipe(
      catchError(error =>[])
    );
  }
